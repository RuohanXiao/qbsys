<template>
  <div>
    ...
    <Modal v-model="flag" width="80%" footer-hide>
      ...
      <Collapse v-model="value1" :style="{textAlign:'left',margin:'10px 0'}"  class="hoverScroll" >
        <Panel v-for="item in edata" :style="{maxHeight:listHeight}">
            {{item.text}}
            <div slot="content">
...
<style>
  ...
  .ivu-modal-content {
    ...
    box-shadow: 1px 1px 18px rgba(24, 255, 255, 0.5) inset;
    /*
