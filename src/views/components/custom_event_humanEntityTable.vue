      ...
      <panel name="1">
        ...
        <div slot="content" class="tableLine">
          ...
          <div class="econtent allowWrap" v-if='tableData.nickname'>
            ...
            <div class="moreDiv" :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.nickname) === 'object'&&tableData.nickname.length>5&&displayMore['nickname']" @click="clickMore('nickname')">
              <p class="econtentp w8em moreP">更多</p>
            </div>
            ...
            <div class="moreDiv" :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.nickname) === 'object'&&tableData.nickname.length>5&&!displayMore['nickname']" @click="clickCutOut('nickname')">
              <p class="econtentp w8em moreP">收起</p>
            </div>
          </div>
          <!-- <div class="econtent" v-if='tableData.date_of_birth'>
                  <p class="econtentp w8em">出生日期</p>
          ...
          <div class="econtent allowWrap" v-if='tableData.date_of_birth'>
            ...
            <div :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.date_of_birth) === 'object'&&index<5" v-for="(it,index) in tableData.date_of_birth">
              <p class="econtentp w8em" v-if="index==0">出生日期</p>
              <p class="econtentp w8em" v-else>&nbsp;</p>
              <p class="econtentp">{{it}}</p>
              <div class="eButton">
            ...
            <div class="moreDiv" :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.date_of_birth) === 'object'&&tableData.date_of_birth.length>5&&displayMore['date_of_birth']" @click="clickMore('date_of_birth')">
              <p class="econtentp w8em moreP">更多</p>
            </div>
            ...
            <div class="moreDiv" :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.date_of_birth) === 'object'&&tableData.date_of_birth.length>5&&!displayMore['date_of_birth']" @click="clickCutOut('date_of_birth')">
              <p class="econtentp w8em moreP">收起</p>
            </div>
          </div>
          <!-- <div class="econtent" v-if='tableData.date_of_death'>
                  <p class="econtentp w8em">死亡日期</p>
          ...
          <div class="econtent allowWrap" v-if='tableData.date_of_death'>
            ...
            <div :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.date_of_death) === 'object'&&index<5" v-for="(it,index) in tableData.date_of_death">
              <p class="econtentp w8em" v-if="index==0">死亡日期</p>
              <p class="econtentp w8em" v-else>&nbsp;</p>
              <p class="econtentp">{{it}}</p>
              <div class="eButton">
            ...
            <div class="moreDiv" :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.date_of_death) === 'object'&&tableData.date_of_death.length>5&&displayMore['date_of_death']" @click="clickMore('date_of_death')">
              <p class="econtentp w8em moreP">更多</p>
            </div>
            ...
            <div class="moreDiv" :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.date_of_death) === 'object'&&tableData.date_of_death.length>5&&!displayMore['date_of_death']" @click="clickCutOut('date_of_death')">
              <p class="econtentp w8em moreP">收起</p>
            </div>
          </div>
          <!-- <div class="econtent" v-if='tableData.date_of_disappearance'>
                  <p class="econtentp w8em">失踪日期</p>
          ...
          <div class="econtent allowWrap" v-if='tableData.date_of_disappearance'>
            ...
            <div :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.date_of_disappearance) === 'object'&&index<5" v-for="(it,index) in tableData.date_of_disappearance">
              <p class="econtentp w8em" v-if="index==0">失踪日期</p>
              <p class="econtentp w8em" v-else>&nbsp;</p>
              <p class="econtentp">{{it}}</p>
              <div class="eButton">
            ...
            <div class="moreDiv" :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.date_of_disappearance) === 'object'&&tableData.date_of_disappearance.length>5&&displayMore['date_of_disappearance']" @click="clickMore('date_of_disappearance')">
              <p class="econtentp w8em moreP">更多</p>
            </div>
            ...
            <div class="moreDiv" :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.date_of_disappearance) === 'object'&&tableData.date_of_disappearance.length>5&&!displayMore['date_of_disappearance']" @click="clickCutOut('date_of_disappearance')">
              <p class="econtentp w8em moreP">收起</p>
            </div>
          </div>
          <!-- <div class="econtent" v-if='tableData.place_of_birth'>
                  <p class="econtentp w8em">出生地</p>
          ...
          <div class="econtent allowWrap" v-if='tableData.place_of_birth'>
            ...
            <div :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.place_of_birth) === 'object'&&index<5" v-for="(it,index) in tableData.place_of_birth">
              <p class="econtentp w8em" v-if="index==0">出生地</p>
              <p class="econtentp w8em" v-else>&nbsp;</p>
              <p class="econtentp">{{it}}</p>
              <div class="eButton">
            ...
            <div class="moreDiv" :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.place_of_birth) === 'object'&&tableData.place_of_birth.length>5&&displayMore['place_of_birth']" @click="clickMore('place_of_birth')">
              <p class="econtentp w8em moreP">更多</p>
            </div>
            ...
            <div class="moreDiv" :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.place_of_birth) === 'object'&&tableData.place_of_birth.length>5&&!displayMore['place_of_birth']" @click="clickCutOut('place_of_birth')">
              <p class="econtentp w8em moreP">收起</p>
            </div>
          </div>
          <div class="econtent allowWrap" v-if='tableData.country_of_citizenship'>
            ...
            <div :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.country_of_citizenship) === 'object'&&index<5" v-for="(country,index) in tableData.country_of_citizenship">
              <p class="econtentp w8em" v-if="index==0">国籍</p>
              <p class="econtentp w8em" v-else>&nbsp;</p>
            ...
            <div class="moreDiv" :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.country_of_citizenship) === 'object'&&tableData.country_of_citizenship.length>5&&displayMore['country_of_citizenship']" @click="clickMore('country_of_citizenship')">
              <p class="econtentp w8em moreP">更多</p>
            </div>
            ...
            <div class="moreDiv" :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.country_of_citizenship) === 'object'&&tableData.country_of_citizenship.length>5&&!displayMore['country_of_citizenship']" @click="clickCutOut('country_of_citizenship')">
              <p class="econtentp w8em moreP">收起</p>
            </div>
          </div>
          <!-- <div class="econtent" v-if='tableData.ethic_group'>
                  <p class="econtentp w8em">所属民族</p>
          ...
          <div class="econtent allowWrap" v-if='tableData.ethic_group'>
            ...
            <div :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.ethic_group) === 'object'&&index<5" v-for="(it,index) in tableData.ethic_group">
              <p class="econtentp w8em" v-if="index==0">所属民族</p>
              <p class="econtentp w8em" v-else>&nbsp;</p>
              <p class="econtentp">{{it}}</p>
              <div class="eButton">
          ...
          <div class="econtent allowWrap" v-if='tableData.religion'>
            ...
            <div :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.religion) === 'object'&&index<5" v-for="(it,index) in tableData.religion">
              <p class="econtentp w8em" v-if="index==0">宗教信仰</p>
              <p class="econtentp w8em" v-else>&nbsp;</p>
              <p class="econtentp">{{it}}</p>
              <div class="eButton">
          ...
          <div class="econtent allowWrap" v-if='tableData.occupation'>
            ...
            <div :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.occupation) === 'object'&&index<5" v-for="(occ,index) in tableData.occupation">
              <p class="econtentp w8em" v-if="index==0">从事职业</p>
              <p class="econtentp w8em" v-else>&nbsp;</p>
              <p class="econtentp">{{occ}}</p>
              <div class="eButton">
                <Button class='bstyle' shape="circle" icon="icon iconfont icon-match-search" @click="addSingleNodeToCanvans(tableData.occupation_ids[index],'entity','')" size='small'></Button>
          ...
          <div class="econtent allowWrap" v-if='tableData.military_rank'>
            ...
            <div :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.military_rank) === 'object'&&index<5" v-for="(occ,index) in tableData.military_rank">
              <p class="econtentp w8em" v-if="index==0">军衔</p>
              <p class="econtentp w8em" v-else>&nbsp;</p>
              <p class="econtentp">{{occ}}</p>
              <div class="eButton">
          ...
          <div class="econtent allowWrap" v-if='tableData.military_branch'>
            ...
            <div :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.military_branch) === 'object'&&index<5" v-for="(occ,index) in tableData.military_branch">
              <p class="econtentp w8em" v-if="index==0">所属军种</p>
              <p class="econtentp w8em" v-else>&nbsp;</p>
              <p class="econtentp">{{occ}}</p>
              <div class="eButton">
          ...
          <div class="econtent allowWrap" v-if='tableData.member_of_political_party'>
            ...
            <div :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.member_of_political_party) === 'object'&&index<5" v-for="(occ,index) in tableData.member_of_political_party">
              <p class="econtentp w8em" v-if="index==0">所属政党</p>
              <p class="econtentp w8em" v-else>&nbsp;</p>
              <p class="econtentp">{{occ}}</p>
              <div class="eButton">
          ...
          <div class="econtent allowWrap" v-if='tableData.award_received'>
            ...
            <div :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.award_received) === 'object'&&index<5" v-for="(occ,index) in tableData.award_received">
              <p class="econtentp w8em" v-if="index==0">荣誉</p>
              <p class="econtentp w8em" v-else>&nbsp;</p>
              <p class="econtentp">{{occ}}</p>
              <div class="eButton">
          ...
          <div class="econtent allowWrap" v-if='tableData.e_mail'>
            ...
            <div :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.e_mail) === 'object'&&index<5" v-for="(occ,index) in tableData.e_mail">
              <p class="econtentp w8em" v-if="index==0">邮箱</p>
              <p class="econtentp w8em" v-else>&nbsp;</p>
              <p class="econtentp">{{occ}}</p>
              <div class="eButton">
          ...
          <div class="econtent allowWrap" v-if='tableData.summary'>
            ...
            <div :style="{display:'flex',width:'100%  '}" v-if="typeof(tableData.summary) === 'object'&&index<5" v-for="(occ,index) in tableData.summary">
              <p class="econtentp w8em" v-if="index==0">简介</p>
              <p class="econtentp w8em" v-else>&nbsp;</p>
              <p class="econtentp">{{occ}}</p>
              <div class="eButton">
      ...
      <panel name="2">
        ...
        <div slot="content" class="tableLine">
          <!-- <div class="econtent" v-if='xiangguanEntityItems.length>0' v-for="items in xiangguanEntityItems">
                <p class="econtentp w8em" :title="items.relation">{{items.relation}}</p>
      ...
      <panel name="3">
        ...
        <div slot="content" class="tableLine">
          <div class="econtent" v-if='xiangguanEvent.statistics&&xiangguanEvent.statistics.length>0' v-for='items in xiangguanEvent.statistics'>
            <!-- <p class="econtentp w8em" :title="items.type">{{myMap1.get(items.type.toLowerCase().replace(/-/, "_")).name}}</p> -->
      ...
      <panel name="4">
        ...
        <div slot="content" class="tableLine">
          <div class="econtent" v-if='xiangguanDoc.statistics&&xiangguanDoc.statistics.length>0' v-for='items in xiangguanDoc.statistics'>
            <p class="econtentp w8em" :title="items.type">{{items.type}}</p>
            <p class="econtentp">{{items.num}}</p>
            <div class="eButton">
