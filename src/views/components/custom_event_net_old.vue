      ...
      changeDetailDiv(id, type) {
        ...
        if (this.myMap.get(type) === 'entity') {
          mthis.$http.post(this.$store.state.ipConfig.api_url + '/entity-detail/', {
            ...
            // res.img = 'http://10.60.1.140/assets/images/other.png'
            res.img = (response.body.data[0].img && util.checkImgExists(response.body.data[0].img)) ? response.body.data[0].img : 'http://10.60.1.140/assets/images/other.png'
            this.detailData = res
          })
