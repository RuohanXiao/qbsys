<template>
  <!-- 集合弹框 -->
  <div>
    <Modal class="modalDiv" width='80vw' footer-hide loading='loading' v-model="showFlagPipei" id='md'>
      ...
      <div class="rightbottom">
        ...
        <Button class='buttonOK' @click='modifySet'>匹配</Button>
      </div>
    </Modal>
  </div>
</template>
