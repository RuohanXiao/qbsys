<template>
  <div :style="{height:nh}">
    <div
      :style="{height:nh,backgroundColor:'rgba(0,0,0,0)',position:'absolute',zIndex: zIndex,top:0,width:'99%',margin:'0 10px'}"
    >
      <Spin size="large" fix v-if="spinShow"></Spin>
      <!-- <Spin size="large" fix v-if="true"></Spin> -->
    </div>
    <div
      :style="{height:'55px',backgroundColor: 'rgba(51, 255, 255, 0.1)',margin:'0 10px 0 10px',border:'solid 1px #336666'}"
      id="net"
    >
      <div class="divStyle">
        ...
        <Tooltip placement="bottom" content="（Ctrl+A）" :delay="1000">
          <div :class="ifSelectNode? 'button-div': 'button-div-disable'" @click="remove">
            <Icon
              class="icon iconfont icon-delete-point DVSL-bar-btn-new DVSL-bar-btn-back"
              size="26"
            ></Icon>
        ...
        <Tooltip placement="bottom" content="（Ctrl+A）" :delay="1000">
          <div :class="ifSelectNode? 'button-div': 'button-div-disable'" @click="star">
            <Icon
              class="icon iconfont icon-star DVSL-bar-btn-new DVSL-bar-btn-back"
              align="center"
              size="26"
            ></Icon>
        ...
        <Tooltip placement="top" content="（Ctrl+A）" :delay="5000">
          ...
          <Dropdown :visible="expandVisible">
            ...
            <div
              :class="ifSelectNode? 'button-div': 'button-div-disable'"
              @mouseover="addExpandTimer()"
              @mouseout="stopExpandTimer()"
              @click="expandNodeKnowledge"
              v-if="(expandFlag=='knowledge')"
            >
              <Icon
                class="icon iconfont icon-guanlianshiti DVSL-bar-btn-new DVSL-bar-btn-back"
                size="26"
              ></Icon>
              <Icon
                class="icon iconfont icon-sanjiao-smaller DVSL-bar-btn-new DVSL-bar-btn-back downIcon"
                size="5"
              ></Icon>
            ...
            <div
              ...
              @mouseover="addExpandTimer()"
              @mouseout="stopExpandTimer()"
              @click="expandNodeEvent"
              v-if="(expandFlag=='event')"
            >
              <Icon
                class="icon iconfont icon-guanlianshijian DVSL-bar-btn-new DVSL-bar-btn-back"
                size="26"
              ></Icon>
              <Icon
                class="icon iconfont icon-sanjiao-smaller DVSL-bar-btn-new DVSL-bar-btn-back downIcon"
            ...
            <div
              ...
              @mouseover="addExpandTimer()"
              @mouseout="stopExpandTimer()"
              v-if="(expandFlag=='content')"
              @click="expandNodeContent"
            >
              <Icon
                class="icon iconfont icon-kuozhan--shijian DVSL-bar-btn-new DVSL-bar-btn-back"
                size="26"
              ></Icon>
              <Icon
                class="icon iconfont icon-sanjiao-smaller DVSL-bar-btn-new DVSL-bar-btn-back downIcon"
            ...
            <DropdownMenu slot="list" placement="bottom-start">
              <div class="button-div" @click="expandNodeKnowledge">
                <DropdownItem class="img-content">
                  <Icon
                    class="icon iconfont icon-guanlianshiti DVSL-bar-btn-new DVSL-bar-btn-back padding6"
                    size="18"
                  ></Icon>
                  <span>关联实体</span>
              ...
              <div class="button-div" @click="expandNodeEvent">
                <DropdownItem class="img-content">
                  <Icon
                    class="icon iconfont icon-guanlianshijian DVSL-bar-btn-new DVSL-bar-btn-back padding6"
                    size="18"
                  ></Icon>
                  <span>关联事件</span>
              ...
              <div class="button-div" @click="expandNodeContent">
                <DropdownItem class="img-content">
                  <Icon
                    class="icon iconfont icon-guanlianwendang DVSL-bar-btn-new DVSL-bar-btn-back padding6"
                    size="18"
                  ></Icon>
                  <span>关联文档</span>
        ...
        <Tooltip placement="top" content="（Ctrl+A）" :delay="5000">
          ...
          <Dropdown :visible="expandGongzhiVisible">
            ...
            <div
              :class="ifSelectNode? 'button-div': 'button-div-disable'"
              @mouseover="addGongzhi()"
              @mouseout="stopGongzhi()"
              @click="gongzhiEnitiy"
              v-if="(expandFlag_gongzhi=='knowledge_gongzhi')"
            >
              <Icon
                class="icon iconfont icon-gongzhishiti DVSL-bar-btn-new DVSL-bar-btn-back"
                size="26"
              ></Icon>
              <Icon
                class="icon iconfont icon-sanjiao-smaller DVSL-bar-btn-new DVSL-bar-btn-back downIcon"
            ...
            <div
              ...
              @mouseout="stopGongzhi()"
              @click="gongzhiEvent"
              v-if="(expandFlag_gongzhi=='event_gongzhi')"
            >
              <Icon
                class="icon iconfont icon-gongzhishijian DVSL-bar-btn-new DVSL-bar-btn-back"
                size="26"
              ></Icon>
              <Icon
                class="icon iconfont icon-sanjiao-smaller DVSL-bar-btn-new DVSL-bar-btn-back downIcon"
            ...
            <div
              ...
              @mouseover="addGongzhi()"
              @mouseout="stopGongzhi()"
              v-if="(expandFlag_gongzhi=='content_gongzhi')"
              @click="gongzhiDoc"
            >
              <Icon
                class="icon iconfont icon-gongzhiwendang DVSL-bar-btn-new DVSL-bar-btn-back"
                size="26"
              ></Icon>
              <Icon
                class="icon iconfont icon-sanjiao-smaller DVSL-bar-btn-new DVSL-bar-btn-back downIcon"
            ...
            <DropdownMenu slot="list" placement="bottom-start">
              <div class="button-div" @click="gongzhiEnitiy">
                <DropdownItem class="img-content">
                  <Icon
                    class="icon iconfont icon-gongzhishiti DVSL-bar-btn-new DVSL-bar-btn-back padding6"
                    size="18"
                  ></Icon>
                  <span>共指实体</span>
                  <span
                    v-if="(expandFlag_gongzhi=='knowledge_gongzhi')"
                    class="dropDownSelectPoint"
                  >●</span>
                  <span v-else class="dropDownSelectPoint">&nbsp;</span>
                </DropdownItem>
              </div>
              <div class="button-div" @click="gongzhiEvent">
                <DropdownItem class="img-content">
                  <Icon
                    class="icon iconfont icon-gongzhishijian DVSL-bar-btn-new DVSL-bar-btn-back padding6"
                    size="18"
                  ></Icon>
                  <span>共指事件</span>
              ...
              <div class="button-div" @click="gongzhiDoc">
                <DropdownItem class="img-content">
                  <Icon
                    class="icon iconfont icon-gongzhiwendang DVSL-bar-btn-new DVSL-bar-btn-back padding6"
                    size="18"
                  ></Icon>
                  <span>共指文档</span>
        ...
        <Tooltip placement="bottom" content="（Ctrl+A）" :delay="5000">
          <div
            :class="ifSelectNode? 'button-div': 'button-div-disable'"
            @mousedown="addStepTimer"
            @click="showModalStep('knowledge')"
            v-show="stepFlag==='knowledge'"
            @mouseup="stopStepTimer"
          >
            <Icon
              class="icon iconfont icon-lujing--tupu DVSL-bar-btn-new DVSL-bar-btn-back"
              size="26"
            ></Icon>
        ...
        <Tooltip placement="bottom" content="（Ctrl+A）" :delay="1000">
          <div :class="ifSelectNode? 'button-div': 'button-div-disable'" @click="toGeo()">
            <Icon
              class="icon iconfont icon-tuisongzhikongjian DVSL-bar-btn-new DVSL-bar-btn-back"
              size="26"
            ></Icon>
        ...
        <Tooltip placement="bottom" content="（Ctrl+A）" :delay="1000">
          <div :class="ifSelectNode? 'button-div': 'button-div-disable'" @click="toContent()">
            <Icon
              class="icon iconfont icon-tuisongzhiwendang DVSL-bar-btn-new DVSL-bar-btn-back"
              size="26"
            ></Icon>
        ...
        <Tooltip placement="bottom" content="（Ctrl+A）" :delay="1000">
          <div
            :class="ifSelectNode? 'button-div': 'button-div-disable'"
            @click="openCreatProjectModal('expend')"
          >
        ...
        <Tooltip placement="bottom" content="（Ctrl+A）" :delay="1000">
          <div class="button-div" @click="fit">
            <Icon
              class="icon iconfont icon-zhengchangshitu--quanping DVSL-bar-btn-new DVSL-bar-btn-back"
              size="26"
            ></Icon>
    ...
    <div
      :style="{height:nh_50,borderRight:'solid 1px #336666',borderLeft:'solid 1px #336666',borderBottom:'solid 1px #336666',margin:'0 10px',backgroundColor:'rgba(0,0,0,0.5)'}"
    >
    ...
    <workset-modal
      :worksetData="worksetData"
      :type="worksetType"
      :flag="worksetFlag"
      :worksetInfo="worksetInfo"
    />
        ...
        events: {
          ...
          onClick: function(event) {
            if (event.clickNode || event.clickLink) {
              ...
              for (
                let selectNum = 0;
                selectNum < event.selection.length;
                selectNum++
              ) {
